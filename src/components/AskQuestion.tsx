          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              >
                <ReactQuill
                  ...
                  value={description}
                  onChange={(value) => {
                    console.log("Markdown input:", value);
            ...
            >
              ...
              <div className="relative">
                ...
                <div
                  className={`min-h-[48px] p-3 rounded-lg border transition-all duration-300 focus-within:ring-2 focus-within:ring-blue-500 ${
                    darkMode
                ...
                >
                  ...
                  <input
                    ...
                    placeholder={
                      tags.length === 0
                        ? "Add tags (e.g., javascript, react, css)"
                        : "Add another tag..."
                    }
